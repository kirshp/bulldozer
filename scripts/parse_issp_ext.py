...
cfg = dict(
    ...
    root=ROOT, site_source='ISSP', site_license='Free for research use (GESIS)', site_url='https://issp.org/',
    ...
    inds=[
        ('Society & values', 'v10', {4, 5}, {1, 2, 3, 4, 5}, 'Interpersonal trust',
         ...
         dict(slug='issp-interpersonal-trust', title='Interpersonal Trust (ISSP)', topic='attitudes')),
        ...
        ('Media', 'v12', {6, 7, 8, 9, 10}, T10, 'Trust in the news media',
         ...
         dict(slug='issp-trust-news-media', title='Trust in the News Media (ISSP)', topic='media')),
